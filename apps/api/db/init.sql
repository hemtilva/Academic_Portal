...
CREATE INDEX IF NOT EXISTS threads_course_student_id_idx ON threads(course_id,student_id);
CREATE INDEX IF NOT EXISTS threads_course_ta_id_idx ON threads(course_id,ta_id);
